...
void t1(word* nb) {
	...
	assert(compareWordArrays((word*)ciphertext, (word*)res_ciphertext, 4));
	assert(compareWordArrays((word*)tag, (word*)res_tag, 4));
...
void t4(word* nb) {
	...
	uint8_t plaintext[32] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e,
							  0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f };
	uint8_t ciphertext[32] = { 0 };
	uint8_t tag[16] = { 0 };

	uint8_t res_ciphertext[32] = { 0xe0, 0x8e, 0xc1, 0x06, 0x85, 0xd6, 0x3c, 0x73, 0x64, 0xec, 0xa7, 0x8f, 0xf6, 0xe1,
								   0xa1, 0xdd, 0xfd, 0xfc, 0x15, 0xd5, 0x31, 0x1a, 0x7f, 0x29, 0x88, 0xa0, 0x47, 0x1a, 0x13, 0x97, 0x3f, 0xd7 };
